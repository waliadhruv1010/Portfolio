      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          <p className="text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-xl">
            I’m a full stack web developer driven by scalable design, clean code,
            and a deep enthusiasm for building impactful applications.
          </p>
          <div>
            <Link
              href="/#contact"
            ...
            <a
              href="/images/Resum_DhruvWalia.pdf"
              download
